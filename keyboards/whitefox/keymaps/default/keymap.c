...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = KEYMAP( \
        ...
        KC_TRNS,KC_TRNS,KC_MPRV,KC_MPLY,KC_MNXT,KC_TRNS,KC_TRNS,KC_TRNS,KC_MUTE, KC_FN3, KC_FN4,KC_TRNS,KC_TRNS,     KC_TRNS,KC_TRNS,\
...
const uint16_t fn_actions[] = {
    ...
    [2] = ACTION_MODS_KEY(MOD_LGUI | MOD_LSFT, KC_VOLU),
};
